...
const create = async (req, res, fileNames) => {
  try {
    ...
    project.team = JSON.parse(daat.team);
...
const preview = async (req, res) => {
  try {
    ...
    let project = Project.findById({ _id: id })
      .populate({
        path: "client",
        model: "Client",
      })
...
module.exports = { create, list, preview, deleteProject, update, byId };
